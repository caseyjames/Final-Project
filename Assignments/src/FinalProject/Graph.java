...
//	}
     ...
     */
    public MyLinkedList<String> dijkstrasShortestPath(String startName, String goalName) {
        ...
        MyLinkedList<String> path = new MyLinkedList<String>();
